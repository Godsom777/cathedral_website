    ...
    <section className=''>
      ...
      <div className="col-12 col-lg-3 mb-8 mb-lg-0">
        <div className="p-2 border rounded-3">
          <a className="btn btn-primary-light text-primary mb-2 text-start w-100" href="#">
            <span className="me-3">
          ...
          <a className="btn mb-2 text-start w-100" href="#">
            <span className="me-3">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M2.42096 16.8743C3.18937 15.5442 4.29425 14.4398 5.62462 13.672C6.95499 12.9042 8.46399 12.5 10 12.5C11.5361 12.5 13.0451 12.9043 14.3754 13.6721C15.7058 14.44 16.8106 15.5444 17.579 16.8744" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
          ...
          <a className="btn mb-2 text-start w-100" href="#">
            <span className="me-3">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.6251 17.5H4.37451C4.20875 17.5 4.04978 17.4342 3.93257 17.3169C3.81536 17.1997 3.74951 17.0408 3.74951 16.875V3.125C3.74951 2.95924 3.81536 2.80027 3.93257 2.68306C4.04978 2.56585 4.20875 2.5 4.37451 2.5H11.8751L16.2501 6.875V16.875C16.2501 16.9571 16.234 17.0383 16.2025 17.1142C16.1711 17.19 16.1251 17.2589 16.0671 17.3169C16.009 17.375 15.9401 17.421 15.8643 17.4524C15.7885 17.4838 15.7072 17.5 15.6251 17.5Z" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M11.875 2.5V6.875H16.2506" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M7.5 10.625H12.5" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M7.5 13.125H12.5" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </span>
          ...
          <a className="btn mb-2 text-start w-100" href="#">
            <span className="me-3">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 16.875C11.2081 16.875 12.1875 15.8956 12.1875 14.6875C12.1875 13.4794 11.2081 12.5 10 12.5C8.79188 12.5 7.8125 13.4794 7.8125 14.6875C7.8125 15.8956 8.79188 16.875 10 16.875Z" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M14.6875 7.49982C15.8956 7.49982 16.875 6.52045 16.875 5.31233C16.875 4.10422 15.8956 3.12485 14.6875 3.12485C13.4794 3.12485 12.5 4.10422 12.5 5.31233C12.5 6.52045 13.4794 7.49982 14.6875 7.49982Z" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M5.3125 7.49982C6.52062 7.49982 7.5 6.52045 7.5 5.31233C7.5 4.10422 6.52062 3.12485 5.3125 3.12485C4.10438 3.12485 3.125 4.10422 3.125 5.31233C3.125 6.52045 4.10438 7.49982 5.3125 7.49982Z" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M5.3125 7.49988V8.12505C5.3125 8.37129 5.361 8.61511 5.45523 8.84261C5.54946 9.0701 5.68757 9.27681 5.86169 9.45092C6.0358 9.62503 6.24251 9.76315 6.47 9.85738C6.69749 9.9516 6.94131 10.0001 7.18754 10.0001L12.8125 9.99998C13.3098 9.99997 13.7867 9.80242 14.1383 9.45078C14.49 9.09914 14.6875 8.62222 14.6875 8.12494V7.49988" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M10.0002 10L10 12.5" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </span>
            <span>API's</span>
          </a>
      ...
      <div className="col-12 col-lg-9">
        <div className="d-flex align-items-center mb-8">
          <span className="d-inline-flex me-6 align-items-center justify-content-center bg-secondary rounded-3" style={{width: 64, height: 64}}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M16.25 4.375H3.75C3.05964 4.375 2.5 4.93464 2.5 5.625V14.375C2.5 15.0654 3.05964 15.625 3.75 15.625H16.25C16.9404 15.625 17.5 15.0654 17.5 14.375V5.625C17.5 4.93464 16.9404 4.375 16.25 4.375Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M2.5 9.375H6.93826C7.08225 9.37497 7.22182 9.42473 7.33331 9.51585C7.4448 9.60696 7.52136 9.73383 7.55 9.87494C7.66536 10.4396 7.97221 10.947 8.41865 11.3115C8.86508 11.6759 9.4237 11.875 10 11.875C10.5763 11.875 11.1349 11.6759 11.5814 11.3115C12.0278 10.947 12.3346 10.4396 12.45 9.87494C12.4787 9.73383 12.5552 9.60696 12.6667 9.51585C12.7782 9.42474 12.9178 9.37497 13.0617 9.375H17.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M2.5 6.875H17.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg>
          </span>
          <div>
            <h5>Payment</h5>
            <p className="text-muted mb-0">Monitor key metrics, check reporting and review insights</p>
          </div>
        </div>
        <div>
          <div className="border rounded-3 p-8 mb-4">
            <a className="fw-bold text-dark text-decoration-none" href="#faq1-1" type="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="faq1-1">Leave it all at that place!</a>
            <div className="collapse show mt-4" id="faq1-1">
              <p className="mw-3xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec urna lacus. Pellentesque in lacus eu est suscipit volutpat eu eget diam. Donec eget justo et diam condimentum bibendum. Donec convallis tellus sem, at lobortis nulla sagittis in. Proin facilisis a enim eget luctus. Sed et maximus libero. Nulla pellentesque imperdiet neque vitae fringilla.</p>
            </div>
          </div>
          <div className="border rounded-3 p-8 mb-4">
            <a className="fw-bold text-dark text-decoration-none" href="#faq1-2" type="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="faq1-1">Leave it all at that place!</a>
            <div className="collapse mt-4" id="faq1-2">
              <p className="mw-3xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec urna lacus. Pellentesque in lacus eu est suscipit volutpat eu eget diam. Donec eget justo et diam condimentum bibendum. Donec convallis tellus sem, at lobortis nulla sagittis in. Proin facilisis a enim eget luctus. Sed et maximus libero. Nulla pellentesque imperdiet neque vitae fringilla.</p>
            </div>
          </div>
          <div className="border rounded-3 p-8 mb-4">
            <a className="fw-bold text-dark text-decoration-none" href="#faq1-3" type="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="faq1-1">Leave it all at that place!</a>
            <div className="collapse mt-4" id="faq1-3">
              <p className="mw-3xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec urna lacus. Pellentesque in lacus eu est suscipit volutpat eu eget diam. Donec eget justo et diam condimentum bibendum. Donec convallis tellus sem, at lobortis nulla sagittis in. Proin facilisis a enim eget luctus. Sed et maximus libero. Nulla pellentesque imperdiet neque vitae fringilla.</p>
            </div>
          </div>
          <div className="border rounded-3 p-8 mb-4">
            <a className="fw-bold text-dark text-decoration-none" href="#faq1-4" type="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="faq1-1">Leave it all at that place!</a>
            <div className="collapse mt-4" id="faq1-4">
              <p className="mw-3xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec urna lacus. Pellentesque in lacus eu est suscipit volutpat eu eget diam. Donec eget justo et diam condimentum bibendum. Donec convallis tellus sem, at lobortis nulla sagittis in. Proin facilisis a enim eget luctus. Sed et maximus libero. Nulla pellentesque imperdiet neque vitae fringilla.</p>
            </div>
          </div>
          <div className="border rounded-3 p-8 mb-4">
            <a className="fw-bold text-dark text-decoration-none" href="#faq1-5" type="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="faq1-1">Leave it all at that place!</a>
            <div className="collapse mt-4" id="faq1-5">
              <p className="mw-3xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec urna lacus. Pellentesque in lacus eu est suscipit volutpat eu eget diam. Donec eget justo et diam condimentum bibendum. Donec convallis tellus sem, at lobortis nulla sagittis in. Proin facilisis a enim eget luctus. Sed et maximus libero. Nulla pellentesque imperdiet neque vitae fringilla.</p>
            </div>
          </div>
                  </div>
