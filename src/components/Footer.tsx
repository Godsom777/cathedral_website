...
const Footer: React.FC = () => {
    return (
        <>
            ...
            <section className="pt-4 p-lg-5 pb-8 bg-black position-relative overflow-hidden w-100">
  <img className="position-absolute bottom-0 start-50 translate-middle-x h-100" src="./gradient.png" alt=""/>
  <div className="container position-relative">
    <div className="row pb-20 mb-6 border-bottom border-secondary-dark">
      <div className="col-12 col-lg-5 mb-16 mb-lg-0">
        <a className="d-inline-block mb-8" href="#">
         <img src="./logo.png" alt="" style={{maxWidth: 100, maxHeight:100}}/>
        </a>
        <p className="text-secondary mw-xs mb-24">Maria Assumpta Cathedral Owerri Imo State Nigeria.</p>
        <div className="d-flex align-items-center">
          <a className="btn p-0 btn-outline-secondary-dark d-inline-flex align-items-center justify-content-center me-2 rounded-pill" href="#" style={{width: 35, height: 35}}>
          ...
          <a className="btn p-0 btn-outline-secondary-dark d-inline-flex align-items-center justify-content-center rounded-pill" href="#" style={{width: 35, height: 35}}>
      ...
      <div className="col-12 col-lg-7">
        <div className="row">
          <div className="col-6 col-md-4 mb-16 mb-md-0">
            <h6 className="fs-9 mb-6 text-uppercase text-secondary">Prishes</h6>
            <ul className="list-unstyled">
              <li className="mb-1"><a className="btn btn-link p-0 text-white" href="#">FInd A Parish</a></li>
              <li className="mb-1"><a className="btn btn-link p-0 text-white" href="#">About Us</a></li>
              <li className="mb-1"><a className="btn btn-link p-0 text-white" href="#">News & Stories</a></li>
              <li><a className="btn btn-link p-0 text-white" href="#">Roadmap</a></li>
            </ul>
          </div>
          <div className="col-6 col-md-4 mb-16 mb-md-0">
            <h6 className="fs-9 mb-6 text-uppercase text-secondary">Important Links</h6>
            <ul className="list-unstyled">
              <li className="mb-1"><a className="btn btn-link p-0 text-white" href="#">Our Journeys</a></li>
              <li className="mb-1"><a className="btn btn-link p-0 text-white" href="#">Donations & Charity</a></li>
              <li className="mb-1"><a className="btn btn-link p-0 text-white" href="#">Roadmap</a></li>
              <li className="mb-1"><a className="btn btn-link p-0 text-white" href="#">Terms & Conditions</a></li>
            
            </ul>
          </div>
          <div className="col-6 col-md-4">
            <h6 className="fs-9 mb-6 text-uppercase text-secondary">Solemnities</h6>
            <ul className="list-unstyled">
              <li className="mb-1"><a className="btn btn-link p-0 text-white" href="#">Season</a></li>
              <li className="mb-1"><a className="btn btn-link p-0 text-white" href="#">Catholic Calendar</a></li>
              <li className="mb-1"><a className="btn btn-link p-0 text-white" href="#">Solemnities</a></li>
    ...
    <div className="text-center">
      <p className="fs-9 text-secondary-light mb-0">Copyright © 2024 ICTDS. All Rights Reserved</p>
    </div>
  </div>
</section>
        </>
